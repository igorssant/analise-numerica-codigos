...
public class MultiploUmTerco{
    ...
    public static void calculaIntegralUmTerco(String funcao){
        ...
        for(int i = 1; i < umTerco.getIntervalo(); i++){
            auxiliar = umTerco.getPontoX0() + (umTerco.getH() * i);
            
            if(i % 2 == 0){
                umTerco.setIntegralCalculada(
                    umTerco.getIntegralCalculada() + 2 * funcao(
                            funcao,
                            auxiliar
                    )
                );
                ...
                umTerco.setIntegralCalculada(
                    umTerco.getIntegralCalculada() + 4 * funcao(
                            funcao,
                            auxiliar
                    )
                );
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, NumberFormatException{
        ...
        umTerco = new Integral(x0, xi, qtdSubintervalos);
