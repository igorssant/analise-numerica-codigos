...
import controller.CalcularEulerMelhorado;
 ...
 */
public class MetodoEulerMelhorado{
    /* ESCOPO DE CLASSE */
    private static Derivada eulerMelhorado;
    /**
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, NumberFormatException{
        ...
        intervaloSaida = xf;
        eulerMelhorado = new Derivada(y, xi, xf, h, intervaloSaida);
        eulerMelhorado = CalcularEulerMelhorado.metodoDeEulerMelhorado(funcao, eulerMelhorado);
        
        try{
            LidarComArquivo.escreverEmArquivo(eulerMelhorado.getValoresDeX(), eulerMelhorado.getValoresDeY());
        }
