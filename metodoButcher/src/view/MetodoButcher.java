...
import controller.CalcularButcher;
 ...
 */
public class MetodoButcher{
    /* ESCOPO DE CLASSE */
    private static Derivada butcher;
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, NumberFormatException{
        ...
        intervaloSaida = xf;
        butcher = new Derivada(y, xi, xf, h, intervaloSaida);
        butcher = CalcularButcher.calcularButcher(funcao, butcher);
        
        try{
            LidarComArquivo.escreverEmArquivo(butcher.getValoresDeX(), butcher.getValoresDeY());
        }
