...
public class RK4{
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, NumberFormatException{
        ...
        intervaloSaida = xf;
        rk4 = new Derivada(y, xi, xf, h, intervaloSaida);
        rk4 = CalcularRK4.calcularRK4(funcao, rk4);
        
        try{
            LidarComArquivo.escreverEmArquivo(rk4.getValoresDeX(), rk4.getValoresDeY());
        }
