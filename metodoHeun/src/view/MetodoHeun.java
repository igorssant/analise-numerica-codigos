...
import controller.CalcularHeun;
...
/* ESCOPO DE CLASSE */
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, NumberFormatException{
        ...
        try{
            ...
            maximoDeIteracoes = Integer.parseInt(conteudoDoArquivo.get(5));
            erroEsperado = Double.parseDouble(conteudoDoArquivo.get(6));
        ...
        intervaloSaida = xf;
        heun = new Derivada(y, xi, xf, h, intervaloSaida);
        heun = CalcularHeun.calcularHeun(funcao, heun, maximoDeIteracoes, erroEsperado);
        
        try{
            LidarComArquivo.escreverEmArquivo(heun.getValoresDeX(), heun.getValoresDeY());
        }
