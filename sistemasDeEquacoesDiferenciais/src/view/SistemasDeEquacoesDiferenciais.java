 ...
 */
public class SistemasDeEquacoesDiferenciais{
    /* ESCOPO DE CLASSE */
    private static Derivada sistemaEquacoes;
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, NumberFormatException{
        ...
        sistemaEquacoes = new Derivada(y, xi, xf, h, intervaloSaida);
        sistemaEquacoes = CalcularEuler.metodoDeEuler(funcao, sistemaEquacoes);
        
        try{
            LidarComArquivo.escreverEmArquivo(sistemaEquacoes.getValoresDeX(), sistemaEquacoes.getValoresDeY());
        }
